...
function loadSettings() {
  ...
  if (settings.apiProvider) {
    const radio = document.querySelector(`input[name="api-provider"][value="${settings.apiProvider}"]`);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // API key inputs
  document.getElementById('anthropicKey').addEventListener('change', saveSettings);
